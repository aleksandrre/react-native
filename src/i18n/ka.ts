const ka = {
  ...
  register: {
    ...
    emailLabel: 'ელ-ფოსტა*',
    emailPlaceholder: 'ელ-ფოსტა',
    phoneLabel: 'ტელეფონი (არასავალდებულო)',
  ...
  profile: {
    ...
    save: 'შენახვა',
    updateFailed: 'პროფილის განახლება ვერ მოხერხდა. სცადეთ ხელახლა.',
    deleteAccount: 'ანგარიშის წაშლა',
    deleteAccountConfirm: 'ნამდვილად გსურთ ანგარიშის წაშლა?',
    cancel: 'გაუქმება',
    delete: 'წაშლა',
    deleteAccountError: 'ანგარიშის წაშლა ვერ მოხერხდა. სცადეთ ხელახლა.',
  },
  dateSelector: {
